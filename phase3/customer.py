...
class XactionConsumer:
    ...
    def handleMessages(self):
        ...
        for msg in self.consumer:
            ...
            get_customers_in_database = self.connection.query(Customer.custid).all()
            self.ledger[message['custid']] = message
            check_list = [person[0] for person in get_customers_in_database if message['custid'] is person[0]]
            # print(check_list)
            #  Yeah I have no idea why it says there is a connection when all connections should have been closed already.
